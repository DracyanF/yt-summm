...
def get_text_primer(df_dataset,df_name):
    ...
    primer_desc = primer_desc + "\nPlease ensure that the output is generated using 'print' statement with tabulate only, keep tablefmt as html. If you want to use tabulate to format the DataFrame, you should pass the DataFrame as the first argument, not its shape."
