...
def get_text_primer(df_dataset,df_name):
    ...
    primer_desc = primer_desc + "\nPlease ensure that the output is generated using 'print' statement with tabulate only, keep tablefmt as html and showindex=False"
    primer_desc = primer_desc + "\nUsing Python version 3.9.12, create a script using the dataframe df to answer the following while showing headers:"
